...
public class WidgetService extends RemoteViewsService {
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        ...
        return new PhotoRVFactory((GalleryApplication) getApplicationContext(),
                id, type, albumPath);
    }
    ...
    private static class PhotoRVFactory implements
        ...
        private final GalleryApplication mApp;

        private WidgetSource mSource;

        public PhotoRVFactory(GalleryApplication app, int id, int type, String albumPath) {
            mApp = app;
            mAppWidgetId = id;
            mType = type;
        ...
        public void onCreate() {
            AppWidgetManager.getInstance(mApp)
