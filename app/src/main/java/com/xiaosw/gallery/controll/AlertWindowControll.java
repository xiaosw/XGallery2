...
public enum  AlertWindowControll {
    ...
    /**
     * 记录当前弹窗
     * @param alertWindow must instanceof {@link android.app.Activity} or {@link android.app.Dialog} or {@link android.widget.PopupWindow}
     */
    ...
    /**
     * 记录弹窗被销毁
     * @param alertWindow 窗口{@link android.app.Activity} or {@link android.app.Dialog} or {@link android.widget.PopupWindow}
     */
